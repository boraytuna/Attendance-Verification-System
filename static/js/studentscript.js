...
document.addEventListener("DOMContentLoaded", function () {
    ...
    ///// Frame 3 - Location and Agreement /////
    const userAgreement = document.getElementById("userAgreement");
    const privacyPolicy = document.getElementById("privacyPolicy");
    const btnAllowLocation = document.getElementById("btnAllowLocation");
    const btnFinish = document.getElementById("btnFinish");
    ...
    ///// Frame 4 - Submit End Location /////
    const btnSubmitEndLocation = document.getElementById("btnSubmitEndLocation");

    btnSubmitEndLocation.addEventListener("click", function () {
        const email = cachedStudent.email;
        const lastName = cachedStudent.lastName;
        const scannedEventID = cachedStudent.scannedEventID;
        ...
        btnSubmitEndLocation.disabled = true; // prevent double clicks
            ...
            navigator.geolocation.getCurrentPosition(
                function (position) {
                    ...
                    .catch(error => {
                        console.error("Fetch error:", error);
                        alert("Network error while submitting location.");
                        btnSubmitEndLocation.disabled = false;
                    });
                },
                error => {
                    console.error("📍 Geolocation error:", error);
